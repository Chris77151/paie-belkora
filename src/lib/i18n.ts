...
export const DICT = {
  ...
  "set.login.hint": { fr: "Traçabilité des accès à l'application — tentatives réussies et échouées. Le mot de passe n'est jamais enregistré.", ar: "تتبُّع الولوج إلى التطبيق — المحاولات الناجحة والفاشلة. لا تُسجَّل كلمة المرور أبداً." },
  ...
  "set.login.filter.all": { fr: "Toutes", ar: "الكل" },
  "set.login.filter.success": { fr: "Réussies", ar: "الناجحة" },
  "set.login.filter.failed": { fr: "Échecs", ar: "الفاشلة" },
