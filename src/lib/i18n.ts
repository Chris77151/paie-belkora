...
export const DICT = {
  ...
  "lv.f.daysHint": { fr: "Pré-rempli en jours calendaires (bornes incluses). Ajustez au besoin : les congés payés se comptent en jours ouvrables.", ar: "يُملأ تلقائيًا بالأيام التقويمية (الحدود متضمَّنة). عدّله عند الاقتضاء: تُحتسب الإجازات المؤدى عنها بأيام العمل." },
