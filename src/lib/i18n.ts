...
export const DICT = {
  ...
  "doc.manual.option": { fr: "— Salarié non enregistré (saisie manuelle) —", ar: "— أجير غير مسجّل (إدخال يدوي) —" },
  "doc.manual.title": { fr: "Salarié hors liste — saisie manuelle (non ajouté au fichier du personnel)", ar: "أجير خارج القائمة — إدخال يدوي (لا يُضاف إلى ملف الموظفين)" },
  "doc.manual.cnss.hint": { fr: "Laisser vide si non encore déclaré à la CNSS (pointillé sur le document).", ar: "اتركه فارغاً إن لم يُصرَّح به بعد لدى CNSS (يظهر منقّطاً في الوثيقة)." },
  "doc.manual.address": { fr: "Adresse", ar: "العنوان" },
  ...
  // Journal des connexions (audit d'accès — super administrateur)
  "set.login.title": { fr: "Journal des connexions", ar: "سجل عمليات الدخول" },
  "set.login.hint": { fr: "Traçabilité des accès à l'application — connexions réussies, échecs et déconnexions. Le mot de passe n'est jamais enregistré.", ar: "تتبُّع الولوج إلى التطبيق — عمليات الدخول الناجحة والفاشلة وعمليات الخروج. لا تُسجَّل كلمة المرور أبداً." },
  "set.login.superOnly": { fr: "Seul le super administrateur peut consulter le journal des connexions.", ar: "يمكن للمدير العام وحده الاطّلاع على سجل عمليات الدخول." },
  "set.login.col.date": { fr: "Date & heure", ar: "التاريخ والساعة" },
  "set.login.col.user": { fr: "Utilisateur", ar: "المستخدم" },
  "set.login.col.outcome": { fr: "Résultat", ar: "النتيجة" },
  "set.login.outcome.success": { fr: "Réussie", ar: "ناجحة" },
  "set.login.outcome.failed": { fr: "Échec", ar: "فاشلة" },
  "set.login.outcome.logout": { fr: "Déconnexion", ar: "تسجيل الخروج" },
  "set.login.reason.empty": { fr: "Champs vides", ar: "حقول فارغة" },
  "set.login.reason.unknown_user": { fr: "Identifiant inconnu", ar: "مُعرِّف غير معروف" },
  "set.login.reason.disabled": { fr: "Compte désactivé", ar: "حساب معطَّل" },
  "set.login.reason.bad_password": { fr: "Mot de passe incorrect", ar: "كلمة مرور خاطئة" },
  "set.login.filter.all": { fr: "Tous les accès", ar: "كل عمليات الولوج" },
  "set.login.filter.success": { fr: "Connexions réussies", ar: "عمليات الدخول الناجحة" },
  "set.login.filter.failed": { fr: "Échecs de connexion", ar: "محاولات الدخول الفاشلة" },
  "set.login.filter.logout": { fr: "Déconnexions", ar: "عمليات الخروج" },
  "set.login.clear": { fr: "Vider le journal", ar: "إفراغ السجل" },
  "set.login.empty": { fr: "Aucune connexion enregistrée.", ar: "لا توجد أي عملية دخول مُسجَّلة." },
  "set.login.count": { fr: "connexion(s) enregistrée(s)", ar: "عملية دخول مُسجَّلة" },
  "set.login.unknownAccount": { fr: "compte inconnu", ar: "حساب غير معروف" },
  ...
  "doclog.kpi.thisMonth": { fr: "Ce mois-ci", ar: "هذا الشهر" },
  "doclog.kpi.distinct": { fr: "Salariés concernés", ar: "الأجراء المعنيون" },
  "doclog.kpi.last": { fr: "Dernier document", ar: "آخر وثيقة" },
  "doclog.kpi.vsPrev": { fr: "vs mois précédent", ar: "مقارنة بالشهر السابق" },
  "doclog.monthly.title": { fr: "Documents par mois", ar: "الوثائق حسب الشهر" },
  "doclog.byType.title": { fr: "Répartition par type", ar: "التوزيع حسب النوع" },
  "doclog.byFormat.title": { fr: "Répartition par format", ar: "التوزيع حسب الصيغة" },
  "doclog.top.title": { fr: "Top salariés", ar: "أكثر الأجراء" },
  "doclog.recent.title": { fr: "Documents récents", ar: "الوثائق الأخيرة" },
  "doclog.col.date": { fr: "Date & heure", ar: "التاريخ والساعة" },
  "doclog.col.type": { fr: "Type", ar: "النوع" },
  "doclog.col.format": { fr: "Format", ar: "الصيغة" },
  "doclog.col.subject": { fr: "Sujet", ar: "الموضوع" },
  "doclog.col.period": { fr: "Période", ar: "الفترة" },
  "doclog.col.author": { fr: "Auteur", ar: "المُنشئ" },
  "doclog.filter.allTypes": { fr: "Tous les types", ar: "كل الأنواع" },
  "doclog.count": { fr: "document(s)", ar: "وثيقة" },
  "doclog.empty": { fr: "Aucun document généré pour cette société. Les documents produits (bulletins, attestations, déclarations…) apparaîtront ici.", ar: "لا توجد وثائق مُنشأة لهذه الشركة. ستظهر هنا الوثائق المُنتَجة (كشوف الأجور، الشهادات، التصاريح…)." },
  "doclog.clear": { fr: "Vider le journal", ar: "إفراغ السجل" },
  // Types de documents
  "doc.type.bulletin": { fr: "Bulletins de paie", ar: "كشوف الأجور" },
  "doc.type.attestation": { fr: "Attestations / certificats", ar: "الشهادات" },
  "doc.type.contrat": { fr: "Contrats de travail", ar: "عقود العمل" },
  "doc.type.disciplinaire": { fr: "Disciplinaire", ar: "التأديب" },
  ...
  "doc.format.apercu": { fr: "Aperçu fidèle", ar: "معاينة مطابقة" },
  "doc.format.latex": { fr: "LaTeX", ar: "LaTeX" },
  "doc.format.bds": { fr: "BDS DAMANCOM", ar: "BDS DAMANCOM" },
  "doc.format.print": { fr: "Impression", ar: "طباعة" },
  // Sociétés (création)
