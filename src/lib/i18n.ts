...
export const DICT = {
  ...
  "nav.livrePaie": { fr: "Livre de paie", ar: "سجل الأجور" },
  ...
  "page.livrePaie.title": { fr: "Livre de paie", ar: "سجل الأجور" },
  "page.livrePaie.sub": { fr: "Registre légal des salaires (art. 371) — automatisé depuis les bulletins validés", ar: "السجل القانوني للأجور (المادة 371) — مُنشأ آليًا من أوراق الأداء المصادَق عليها" },
  "lp.all": { fr: "Tous les mois", ar: "كل الأشهر" },
  "lp.total": { fr: "Total", ar: "المجموع" },
  "lp.empty": { fr: "Aucun bulletin validé pour cette période. Validez d'abord la paie dans le volet « Paie ».", ar: "لا توجد ورقة أداء مصادَق عليها لهذه الفترة. صادِق أولًا على الأجور في قسم «الأجور»." },
  "lp.pdf": { fr: "PDF (paysage)", ar: "PDF (أفقي)" },
  "lp.excel": { fr: "Excel (complet)", ar: "Excel (كامل)" },
  "lp.note": { fr: "Livre de paie établi à partir des bulletins validés (aucune ressaisie). Le PDF présente les colonnes essentielles ; l'Excel porte l'intégralité (détail des heures, état civil). À conserver au moins deux ans (art. 373).", ar: "سجل الأجور مُنشأ من أوراق الأداء المصادَق عليها (دون إعادة إدخال). يعرض ملف PDF الأعمدة الأساسية، ويحمل ملف Excel كامل البيانات. يُحفظ سنتين على الأقل (المادة 373)." },
  "lp.kpi.bulletins": { fr: "Bulletins", ar: "أوراق الأداء" },
  "lp.kpi.bulletins.sub": { fr: "Lignes du registre", ar: "أسطر السجل" },
  "lp.kpi.masse": { fr: "Masse salariale brute", ar: "الكتلة الأجرية الخام" },
  "lp.kpi.masse.sub": { fr: "Cumul de la période", ar: "مجموع الفترة" },
  "lp.kpi.retenues": { fr: "Retenues salariales", ar: "الاقتطاعات الأجرية" },
  "lp.kpi.retenues.sub": { fr: "CNSS + AMO + IR", ar: "الضمان + التأمين + الضريبة" },
  "lp.kpi.net": { fr: "Net à payer", ar: "الصافي المستحقّ" },
  "lp.kpi.net.sub": { fr: "Cumul de la période", ar: "مجموع الفترة" },
  ...
  "emp.status.active": { fr: "Actif", ar: "نشط" },
  "emp.status.exited": { fr: "Sorti", ar: "مغادر" },
  "emp.status.inactive": { fr: "Inactif", ar: "غير نشط" },
  "emp.reinstate": { fr: "Réintégrer", ar: "إعادة الإدماج" },
  "emp.reinstate.hint": { fr: "Efface la date de sortie et réactive le salarié.", ar: "يمسح تاريخ المغادرة ويعيد تفعيل الأجير." },
  ...
  "emp.seniorityBonus": { fr: "Appliquer la prime d'ancienneté", ar: "تطبيق علاوة الأقدمية" },
  "emp.seniorityBonus.hint": { fr: "Droit légal (art. 350-352). Décocher uniquement pour un cas conventionnel particulier.", ar: "حق قانوني (المواد 350-352). لا تُلغِ التحديد إلا لحالة اتفاقية خاصة." },
  "emp.senioTrack.title": { fr: "Suivi de la prime d'ancienneté — revalorisations à venir", ar: "تتبع علاوة الأقدمية — الزيادات القادمة" },
  "emp.senioTrack.sub": { fr: "Franchissements de palier (redressement automatique du taux) dans les 12 prochains mois.", ar: "بلوغ العتبات (تحيين تلقائي للنسبة) خلال 12 شهراً القادمة." },
  "emp.senioTrack.current": { fr: "Taux actuel", ar: "النسبة الحالية" },
  "emp.senioTrack.next": { fr: "Revalorisation", ar: "الزيادة" },
  "emp.senioTrack.newRate": { fr: "Nouveau taux", ar: "النسبة الجديدة" },
  "emp.senioTrack.soon": { fr: "à prévoir", ar: "مرتقب" },
  ...
  "pay.f.advances.hint": { fr: "Retenue du mois — remplie depuis le registre ci-dessous", ar: "اقتطاع الشهر — يُملأ من السجل أدناه" },
  "adv.title": { fr: "Avances sur salaire", ar: "التسبيقات على الأجر" },
  "adv.outstanding": { fr: "Solde restant dû", ar: "الرصيد المتبقي" },
  "adv.dueThisMonth": { fr: "Retenue proposée ce mois", ar: "الاقتطاع المقترح لهذا الشهر" },
  "adv.apply": { fr: "Appliquer au bulletin", ar: "تطبيق على البطاقة" },
  "adv.capNote": { fr: "Écrêtée au plafond légal (1/10 du net, art. 386 CT) — durée réelle de remboursement allongée.", ar: "مقتطعة عند السقف القانوني (عُشر الصافي، المادة 386) — تمتد مدة السداد الفعلية." },
  "adv.none": { fr: "Aucune avance enregistrée pour ce salarié.", ar: "لا يوجد تسبيق مسجّل لهذا الأجير." },
  "adv.add": { fr: "+ Nouvelle avance", ar: "+ تسبيق جديد" },
  "adv.kind": { fr: "Nature", ar: "الطبيعة" },
  "adv.kind.acompte": { fr: "Acompte (salaire déjà gagné — retenu en une fois)", ar: "دفعة (أجر مكتسب — يُقتطع دفعة واحدة)" },
  "adv.kind.avance": { fr: "Avance / prêt (échelonné, plafonné 1/10)", ar: "تسبيق / سلفة (مقسّط، سقف العُشر)" },
  "adv.amount": { fr: "Montant (DH)", ar: "المبلغ (د.م)" },
  "adv.months": { fr: "Échéances (mois)", ar: "الأقساط (أشهر)" },
  "adv.startMonth": { fr: "1re retenue (mois)", ar: "أول اقتطاع (شهر)" },
  "adv.reason": { fr: "Motif (optionnel)", ar: "السبب (اختياري)" },
  "adv.installment": { fr: "Échéance", ar: "القسط" },
  "adv.save": { fr: "Enregistrer", ar: "حفظ" },
  "adv.delete": { fr: "Supprimer", ar: "حذف" },
  "adv.remaining": { fr: "reste", ar: "المتبقي" },
  ...
  "lv.col.actions": { fr: "Actions", ar: "إجراءات" },
  "lv.deleteConfirm": { fr: "Supprimer cette absence du journal ?", ar: "حذف هذا الغياب من السجل؟" },
  "lv.form.title": { fr: "Saisie d'une absence", ar: "تسجيل غياب" },
  "lv.f.employee": { fr: "Salarié", ar: "الأجير" },
  "lv.f.type": { fr: "Type d'absence", ar: "نوع الغياب" },
  "lv.f.days": { fr: "Nombre de jours décompté", ar: "عدد الأيام المحتسبة" },
  "lv.f.daysHint": { fr: "Pré-rempli en jours ouvrables : week-end (repos) et jours fériés fixes exclus. Ajustez au besoin (fêtes religieuses variables, jour de repos particulier).", ar: "يُملأ تلقائيًا بأيام العمل: تُستثنى عطلة نهاية الأسبوع (الراحة) والأعياد الرسمية الثابتة. عدّله عند الاقتضاء (الأعياد الدينية المتغيّرة، يوم راحة خاص)." },
  "lv.f.restDays": { fr: "Repos hebdomadaire (décompte)", ar: "الراحة الأسبوعية (الاحتساب)" },
  "lv.rest.sun": { fr: "Dimanche", ar: "الأحد" },
  "lv.rest.satsun": { fr: "Samedi et dimanche", ar: "السبت والأحد" },
  "lv.dc.cal": { fr: "cal.", ar: "تقويمي" },
  "lv.dc.rest": { fr: "repos", ar: "راحة" },
  "lv.dc.hol": { fr: "férié(s)", ar: "عطلة" },
  "lv.dc.work": { fr: "décomptés", ar: "محتسب" },
  "lv.f.ipe": { fr: "Arrêt indemnisé par la CNSS (IPE / indemnités journalières)", ar: "توقف معوَّض من طرف الصندوق الوطني للضمان الاجتماعي (تعويضات يومية)" },
  "lv.f.dateError": { fr: "La date de fin doit être postérieure ou égale à la date de début.", ar: "يجب أن يكون تاريخ الانتهاء بعد تاريخ البداية أو مساويًا له." },
